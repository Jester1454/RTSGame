...
//	public bool ClickEnabled = false;//	NOT IMPLENTED!
	...
	public delegate void OnClickTapOnBase(Base startBase, Base finishBase);
	public virtual event OnClickTapOnBase onClickTapOnBase = delegate {};
	...
	protected void RaiseClickTapOnBase(Base startBase, Base finishBase)
	{
		onClickTapOnBase(startBase, finishBase);
	}
